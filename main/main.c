...
void menu(lv_obj_t *tabview, lv_obj_t *tab1, lv_obj_t *tab2);
signed int id = 0;
signed int dir = -1;
/**********************
 *   APPLICATION MAIN
...
void guiTask() {
	...
	static lv_obj_t *tabview, *tab1, *tab2;
...
void menu(lv_obj_t *tabview, lv_obj_t *tab1, lv_obj_t *tab2) {
	lv_obj_t *tab3 = lv_tabview_add_tab(tabview, "OO");
}
